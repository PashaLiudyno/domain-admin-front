        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            <Dialog open={open} onClose={handleClose}>
                ...
                <DialogContent>
                    ...
                    <input value={registrar} onChange={(e) => setRegistrar(e.target.value)} className='domain-input' placeholder='Укажите регистратора'></input>
                    <DatePicker value={dateCreated}
                        format="DD/MM/YYYY"
                        onChange={(newValue) => setDateCreated(newValue)} label="Дата создания" />
